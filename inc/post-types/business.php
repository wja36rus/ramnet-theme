...
/**
 * Display custom column data for business
 */
function ramnet_busines_custom_column( $column, $post_id ) {
    switch ( $column ) { 
        case 'thumbnail':
...
add_action( 'manage_ramnet_busines_posts_custom_column', 'ramnet_busines_custom_column', 10, 2 );